...
<div id="about" class="section">
     <div class="container">
        <div class="row">
            <div class="col-md-6 wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
                <div class="entry">
                    <div class="boxtitle">
                        <h2 class="the-title">
    Who I am</h2>
    ...
    <p>What I love above all things is pushing the limits of ergonomics and conception without ever neglecting user experience. Let's work on great projects together.</p>
            ...
            <div class="col-md-6 wow bounceInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                <div class="entry">
                    <div class="boxtitle">
                        <h2 class="the-title">Skill</h2>
                    </div>
                    <ul id="skill">
                        <li>
                            <h3>
                            <i class="icon-paint">&nbsp;</i>
                            <span class="skillname">Web design (UI / UX)</span>
                            <span class="counter">90</span><span class="percent">%</span>
                            </h3>
                            <div class="progress">
                                <div class="webdesign progress-bar"></div>
                            </div>
                        </li>
                        <li>
                            <h3>
                            <i class="icon-html5">&nbsp;</i>
                            <span class="skillname">HTML5</span>
                            <span class="counter">95</span><span class="percent">%</span>
                            </h3>
                            <div class="progress">
                                <div class="html5 progress-bar"></div>
                            </div>
                        </li>
                        <li>
                            <h3>
                            ...
                            <span class="counter">80</span><span class="percent">%</span>
                            </h3>
                            <div class="progress">
                                <div class="javascript progress-bar"></div>
                            </div>
                        </li>
                        <li>
                            <h3>
                            ...
                            <div class="progress">
                                <div class="css3 progress-bar"></div>
                            </div>
                        </li>
                        <li>
                            <h3>
                            ...
                            <span class="counter">65</span><span class="percent">%</span>
                            </h3>
                            <div class="progress">
                                <div class="php progress-bar"></div>
                            </div>
                        </li>
                        <li>
                            <h3>
                            ...
                            <span class="counter">85</span><span class="percent">%</span>
                            </h3>
                            <div class="progress">
                                <div class="wordpress progress-bar"></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<div id="services" class="section section-feature">
...
<div id="experience" class="section">
    ...
    <section id="cd-timeline" class="cd-container">
        <div class="cd-timeline-block">
            <div class="cd-timeline-img cd-time">
